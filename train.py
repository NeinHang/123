...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = 'model_data/vis_classes.txt'
    #---------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = '/content/gdrive/MyDrive/Models/yolov-lite-pytorch/model_data/yolov4_densenet121_voc/yolov4_densenet121_voc.pth'
    #------------------------------------------------------#
